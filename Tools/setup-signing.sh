#!/bin/zsh
# Creates a stable, self-signed code-signing identity for WinKeys in its own
...
IDENTITY="WinKeys Signing"
KC="$HOME/Library/Keychains/winkeys-signing.keychain-db"
KCPASS="winkeys-signing"
